class ChecksController < SecuredController
  ...
  private
    ...
    def check_params
      params.require(:check).permit(:category, :name, :condition_query, :condition_operator, :condition_aggregator, :condition_value, :severity, :interval, :is_locked, :last_ran_at, :team_id, :datasource_id, :documentation_url)
    end
end
